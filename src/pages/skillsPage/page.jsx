...
const DESIGN_SKILLS = [
  ...
  {
    id: "adobe-xd", name: "Adobe XD", category: "Web Design",
    level: "Advanced", proficiency: 4, accent: "#ff61f6", Icon: Palette,
    tags: ["UI/UX", "Wireframing", "Prototyping", "Handoff"],
    desc: "Professional-grade wireframing and prototyping for client projects. Expertise in responsive design systems, interactive prototypes, and developer handoff workflows.",
    projects: ["Client Projects", "Web Redesigns"],
    since: "2023",
  },
  {
    id: "photoshop", name: "Photoshop", category: "Photo Editing",
    level: "Advanced", proficiency: 4, accent: "#31c5f0", Icon: ImageIcon,
    tags: ["Photo Retouching", "Compositing", "Color Grading", "Effects"],
    desc: "Advanced photo editing and digital art. Color correction, retouching, layer mastery, and creating sophisticated composites for portfolio pieces and client deliverables.",
    projects: ["Portfolio Imagery", "Client Assets", "Marketing Materials"],
    since: "2022",
  },
  {
    id: "lightroom", name: "Lightroom", category: "Photo Editing",
    level: "Advanced", proficiency: 4, accent: "#0066cc", Icon: ImageIcon,
    tags: ["Photo Workflow", "Color Grading", "Batch Processing", "Presets"],
    desc: "Efficient photo management and batch editing. Non-destructive workflow optimization with emphasis on color grading consistency across photo series.",
    projects: ["Photography Projects", "Portfolio Curation"],
    since: "2022",
  },
  {
    id: "premiere-pro", name: "Premiere Pro", category: "Video Editing",
    level: "Advanced", proficiency: 4, accent: "#9999ff", Icon: Film,
    tags: ["Video Editing", "Motion Graphics", "Color Grading", "Sound Design"],
    desc: "Full-featured video production from cut to delivery. Multi-camera editing, motion graphics integration, color grading, and audio mixing for short-form and long-form content.",
    projects: ["Demo Videos", "Promotional Content", "Tutorial Series"],
    since: "2024",
  },
  {
    id: "after-effects", name: "After Effects", category: "Video Editing",
    level: "Intermediate", proficiency: 3, accent: "#cc99ff", Icon: Film,
    tags: ["Motion Graphics", "VFX", "Animation", "Text Animation"],
    desc: "Motion graphics and visual effects creation. Keyframe animation, dynamic text effects, and integrating visual elements with live-action footage.",
    projects: ["Animated Explaners", "UI/UX Demos"],
    since: "2024",
  },
  {
    id: "illustrator", name: "Illustrator", category: "Web Design",
    level: "Intermediate", proficiency: 3, accent: "#ff9900", Icon: Palette,
    tags: ["Vector Design", "Icon Design", "Logo Design", "Typography"],
    desc: "Vector graphics and scalable design creation. Expertise in icon systems, logo design, and creating crisp web-ready graphics.",
    projects: ["Icon Systems", "Logo Variations", "Vector Assets"],
    since: "2023",
  },
  {
    id: "typography", name: "Typography & Type", category: "Web Design",
    level: "Advanced", proficiency: 4, accent: "#8B4513", Icon: Layers,
    tags: ["Font Pairing", "Hierarchy", "Web Fonts", "Type Systems"],
    desc: "Expert in font selection, pairing, and implementing comprehensive typographic systems. Understanding of readability, hierarchy, and creating distinctive type-forward designs.",
    projects: ["All Design Projects"],
    since: "2022",
  },
  {
    id: "color-theory", name: "Color Theory & Palettes", category: "Web Design",
    level: "Advanced", proficiency: 4, accent: "#d63bff", Icon: PaintBucket,
    tags: ["Color Psychology", "Accessibility", "Palette Design", "Gradients"],
    desc: "Deep understanding of color psychology, accessibility compliance (WCAG), and creating cohesive color systems that reinforce brand identity.",
    projects: ["All Projects", "Design Systems"],
    since: "2022",
  },
  {
    id: "ux-design", name: "UX/UI Design", category: "Web Design",
    level: "Advanced", proficiency: 4, accent: "#60a5fa", Icon: Box,
    tags: ["User Research", "Wireframing", "Prototyping", "Usability Testing"],
    desc: "Comprehensive UX design from discovery through delivery. User research, persona development, journey mapping, and iterative testing to create intuitive, accessible interfaces.",
    projects: ["Opitulare", "Workable", "Coalitus", "Terrarium"],
    since: "2023",
  },
  {
    id: "web-standards", name: "Web Design Standards", category: "Web Design",
    level: "Advanced", proficiency: 4, accent: "#38bdf8", Icon: Globe,
    tags: ["Responsive Design", "Accessibility", "Performance", "Best Practices"],
    desc: "Deep knowledge of modern web design standards including responsive design patterns, WCAG 2.1 accessibility, performance optimization, and browser compatibility.",
    projects: ["All Web Projects"],
    since: "2023",
  },
  {
    id: "design-systems", name: "Design Systems", category: "Tools",
    level: "Advanced", proficiency: 4, accent: "#10b981", Icon: Wrench,
    tags: ["Component Libraries", "Token Systems", "Documentation", "Scalability"],
    desc: "Creating and maintaining scalable design systems. Component architecture, design tokens, living documentation, and ensuring consistency across products.",
...
const T = {
  ...
  "fantasy-morning": {
    ...
    rowHoverBg: "rgba(40,130,50,0.16)",
...
function Sidebar({ filter, onFilter, p, categories, categoryIcons }) {
  ...
  const levelCounts = Object.entries(LEVELS).map(([key, meta]) => ({
    key,
    ...meta,
    count: (categoryIcons === TECH_CATEGORY_ICONS ? TECH_SKILLS : DESIGN_SKILLS).filter((s) => s.level === key).length,
  }));
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
          {levelCounts.map(({ key, color, count }) => (
            <div key={key} style={{ display: "flex", alignItems: "center", gap: 9 }}>
              ...
              />
              <span style={{ fontFamily: p.mono, fontSize: "0.65rem", letterSpacing: "0.08em", color: p.sub, flex: 1, fontWeight: 500 }}>
                {key}
              </span>
              <span style={{ fontFamily: p.mono, fontSize: "0.58rem", color: p.sub, opacity: 0.45, fontWeight: 500 }}>
                {count}
              </span>
            </div>
          ))}
    ...
    >
      ...
      >
        ...
        <div style={{ minWidth: 0 }}>
          <div
            style={{
              ...
              fontSize: "clamp(1.1rem, 1.3vw, 1.24rem)",
              fontWeight: 700,
              color: p.titleC,
        ...
        <div style={{ flexShrink: 0, textAlign: "right" }}>
          ...
          <div style={{ fontFamily: p.mono, fontSize: "0.72rem", color: p.sub, fontWeight: 700, marginTop: 1 }}>
            {skill.since}
          </div>
        </div>
                ...
                <div style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: 18 }}>
                  <div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <span style={{ fontFamily: p.mono, fontSize: "0.68rem", color: levelMeta.color, fontWeight: 700 }}>
                        {skill.proficiency}/5
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 9 }}>
                      <Cpu size={11} color={p.metaLabelC} />
                      <span
                        style={{
                          fontFamily: p.mono,
                          fontSize: "0.62rem",
                  ...
                  <div style={{ marginTop: "auto", display: "flex", alignItems: "center", gap: 6 }}>
                    <Calendar size={11} color={p.metaLabelC} />
                    <span
                      style={{
                        fontFamily: p.mono,
                        fontSize: "0.58rem",
...
function CategoryDivider({ label, count, p }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 10, marginTop: 4 }}>
      ...
      />
      <span style={{ fontFamily: p.mono, fontSize: "0.58rem", color: p.sub, opacity: 0.38, flexShrink: 0, fontWeight: 500 }}>
        {count}
      </span>
    </div>
  );
...
export default function SkillsPage() {
  ...
  const categories = isDesignMode ? DESIGN_CATEGORIES : TECH_CATEGORIES;
  const categoryIcons = isDesignMode ? DESIGN_CATEGORY_ICONS : TECH_CATEGORY_ICONS;
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 1, background: p.bgGradient, transition: "background 0.7s" }} />
      {p.showGrid && (
        <div
          style={{
            position: "absolute",
